...
{IF ERR_PASSWORD_INVALID}
   <p><img src="../templates/default/images/icon16_error.png" alt="Error" class="icon" />The old password is invalid. Please, try again.</p>
{END ERR_PASSWORD_INVALID}

{IF ERR_PASSWORD_DIFFERENT}
   <p><img src="../templates/default/images/icon16_error.png" alt="Error" class="icon" />You must re-enter the new password for confirmation.</p>
{END ERR_PASSWORD_DIFFERENT}

{IF ERR_PASSWORD_SHORT}
   <p><img src="../templates/default/images/icon16_error.png" alt="Error" class="icon" />The new password must be at least 6 characters long.</p>
{END ERR_PASSWORD_SHORT}

{IF MSG_CHANGE_SUCCESS}
  <p><img src="../templates/default/images/icon16_success.png" alt="Success" class="icon" />Your password has been changed successfully.</p>
